<?php get_header(); ?>
    ...
    <div class="container pt-[200px] mb-80 flex justify-center">
        <div class="w-8/12">
            <div class="article-header flex flex-col">
                ...
                <span class="pretitle-1 text-chocolate-400 mb-24">Posté le <?= the_date() ?></span>
                <img src="<?= $thumbnail_url ?>" class="object-cover aspect-[11/8]"/>
            </div>
            <div class="article-content mt-40">
                <?php the_content(); ?>
            </div>
            <div class="newsletter mt-48 pt-32 border-t border-chocolate-200">
                <span class="pretitle-1 text-chocolate-400">Suivez-nous</span>
    ...
    <?php else : ?>
        <div class="hero flex flex-col gap-48 items-center justify-center h-[400px] bg-sage-400 text-pure-white px-24 pt-80">
