...
<div class="hero flex flex-col gap-48 items-center justify-center h-[400px] bg-sage-400 text-pure-white px-24 pt-96">
...
<div class="background-container bg-soft-white-200 pt-48 pb-48 my-80">
    <div class="container contact-section flex flex-col md:flex-row items-center justify-center pretitle-1 gap-24">
        <div class="contact-item flex flex-row md:flex-col items-center md:text-center w-full md:w-3/12 gap-16">
            <div class="icon w-64 h-64 bg-sage-100 flex items-center justify-center rounded-full">
        ...
        <div class="contact-item flex flex-row md:flex-col items-center md:text-center w-full md:w-3/12 gap-16">
            ...
            <span>Téléphone</br>05 19 08 10 11</span>
        </div>
    </div>
</div>
<div class="container">
