...
const mobileMenuElem = document.querySelector("header > .main-nav > .mobile-menu")
...
const logoElem = document.querySelector("header > .main-nav > .navbar > .logo > a > img");
...
const logo = {
    white: `${wpData.templateUrl}/img/obistroy-white.svg`,
    black: `${wpData.templateUrl}/img/obistroy-black.svg`
}
...
function triggerNavScroll(state) {
    if (state) {
        ...
        mobileMenuElem.classList.add("border-chocolate-700");
        ...
        mobileMenuElem.classList.remove("border-chocolate-700");
...
function initSlider(sliderId){
    ...
    if(maxItems < 3){
        slideRight.classList.add("text-chocolate-100");
    }
    ...
    window.addEventListener("resize", event => {
        ...
        if(maxItems >= 3){
            slideRight.classList.remove("text-chocolate-100");
        }
        slideLeft.classList.add("text-chocolate-100");
        itemsIndex = 1;
        translateValuePx = 0;
    })
    ...
    function refreshControls(){
        ...
        slideLeft.classList.remove("text-chocolate-100");
        slideRight.classList.remove("text-chocolate-100");
